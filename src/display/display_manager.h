...
public:
    ...
    void clearClipRect();
    int16_t getTextWidth(const String& text, uint8_t font);
    void setBacklightLevel(uint8_t percent) { driver.setBacklightLevel(percent); }
    bool hasBacklightControl() const { return driver.hasBacklightControl(); }
