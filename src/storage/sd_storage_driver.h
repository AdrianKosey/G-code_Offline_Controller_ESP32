...
public:
    ...
    bool isAvailable() override
    {
        ...
        unsigned long interval = available ? CHECK_INTERVAL_AVAILABLE_MS : 3000;
...
private:
    ...
    static constexpr unsigned long CHECK_INTERVAL_AVAILABLE_MS = 1000;
    static constexpr unsigned long CHECK_INTERVAL_MISSING_MS = 4000;
};